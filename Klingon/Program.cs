    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (args == null || args.Length < 1)
            {
                ...
                Console.WriteLine("\n");
                Console.WriteLine("        --------------------------------------------------------------");
                Console.WriteLine("        -------------- Bem vindo ao Klingon! --------------");
                Console.WriteLine("        --------------------------------------------------------------");

                Console.WriteLine("\n");
                Console.WriteLine("Pressione R para executar os métodos: ");
